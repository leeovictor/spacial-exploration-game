...
- **Tech Stack**: Luaua, Roblox Studio, React Lua, Rojo
- **Architecture**: Client-server with shared modules, modular game systems, data-driven design
- **Build Tool**: Rojo for syncing with Roblox Studio
- **Testing**: no test yet
- **Code Style**: Follow Roblox Lua conventions, use descriptive names
